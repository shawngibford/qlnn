...
\textemdash{} is FALSIFIED across two PRIMARY verdicts (full-ladder
solver task at $n=24$, with the point-estimate sign inverted relative
to the original hypothesis; and forecaster task at $n=9$ with the
CI excluding zero negatively) and three additional layered sensitivity
points (default-Adam combined $n=18$, symmetric-HPO $n=9$, and the
original P5 forecaster $n=9$). The expanded matrix surfaces a
positive sub-finding: the trainable-embedding quantum PINN with QNN
encoder (te\_qpinn\_qnn) exhibits a $24\times$ tighter seed standard deviation
