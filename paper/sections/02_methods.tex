...
in \texttt{PRE\_REG\_AMENDMENT.md} (A1--A11). They were necessary
...
key amendments are: A1 (skyline threshold = 0.5; sensitivity at
0.75 reported); A4 (MLP capacity 3.3$\times$ Neural-ODE,
violating the original ``within factor of 2'' rule, disclosed and
shown not to affect the verdict sign); A7 (strict-versus-raw
underfit-guard reporting); A9 (symmetric quantum HPO sensitivity);
A10 (combined ODE+PDE verdict at $n=18$); A11 (full-ladder
expansion to $n=24$ + KdV/Kuramoto deferral rationale).
